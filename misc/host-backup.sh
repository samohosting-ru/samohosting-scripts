...
while true; do
  if (whiptail --backtitle "Proxmox VE Helper Scripts: Samohosting Edition v0.6.1" --title "Proxmox VE Host Backup" --yesno "This will create backups for particular files and directories located within a designated directory. Proceed?" 10 88); then
    perform_backup
  else
    break
  fi
