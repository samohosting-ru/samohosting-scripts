...
header_info
echo "Загрузка..."
whiptail --backtitle "Proxmox VE Helper Scripts: Samohosting Edition v0.6.1" --title "Proxmox VE LXC Updater" --yesno "This Will Update LXC Containers. Proceed?" 10 58 || exit
NODE=$(hostname)
EXCLUDE_MENU=()
MSG_MAX_LENGTH=0
